...
- **Sales Cloud.** Its own root vault since 2026-09-24, [SF_Sales/](../SF_Sales/INDEX.md). The share rows teams and territories add stay here in [07-security · 10](07-security-and-sharing/10-teams-territories-and-account-sharing.md), and the object graph in [08-data · 04](08-data-modeling-and-large-data-volumes/04-standard-crm-object-map.md); *team roles, splits, territory forecasts and lead conversion* are there. It was parked here as "Sales Cloud functional depth" until then.
- **OmniStudio**, **Reporting & Analytics.** Not excluded on merit — just not in this build. Add as areas 11–12 later if wanted. *(The reserved area-10 slot was taken by [SOQL & SOSL](10-soql-and-sosl/INDEX.md) in phase 22 — the query language had no owner and SOSL was the vault's largest single gap.)*
