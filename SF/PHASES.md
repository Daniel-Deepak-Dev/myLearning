...
- **Movable:** the 08 Data block (14–15) had nothing downstream depending on it. *(Both ran here, out of numeric order with 16–19 still open — that was the point of calling the block movable. **Areas 08 and 09 are now complete**; the remaining work is **phase 19** alone — the last Experience Cloud run.)*
...
- **`Experience Delivery` presented as GA**, or an SSR/CDN performance claim that does not say **Beta**. Summer '24 onward, **Build Your Own (LWR) only**, EE/PE/UE, **no Developer Edition** — so a scratch-org demo cannot prove it.
