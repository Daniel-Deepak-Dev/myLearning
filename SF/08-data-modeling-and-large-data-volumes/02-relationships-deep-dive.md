...
- **`__r` is the traversal name.** Child-to-parent is 5 levels in SOQL, parent-to-child is 1 level of subquery — a modelling constraint, not just a query one → [02-apex · 03](../02-apex-and-triggers/03-soql-fundamentals-and-relationship-queries.md).
