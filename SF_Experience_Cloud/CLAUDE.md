...
- **There is no SSR to plan for.** **Experience Delivery is being discontinued in Winter '27** and is already closed to new enablement. An LWR site's performance story is **static build + CDN** → [02](02-lwr-architecture-and-build-model.md), [16](16-site-performance-caching-and-seo.md).
