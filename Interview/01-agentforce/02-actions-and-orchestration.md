...
**Level:** Medium · **Probes:** [Custom Agent Actions](../../SF_Agentforce/INDEX.md) · [Idempotency & retries](../../SF_core/06-integration-and-apis/23-idempotency-retries-and-error-handling.md)
...
**Level:** Medium · **Probes:** [Custom Agent Actions](../../SF_Agentforce/INDEX.md) · [Invocable Apex & Agentforce actions](../../SF_core/02-apex-and-triggers/22-invocable-apex-and-agentforce-actions.md) · [Trust Layer](../../SF_Agentforce/INDEX.md)
...
**Level:** Complex · **Probes:** [Multi-Agent Orchestration](../../SF_Agentforce/INDEX.md) · [Observability & Testing](../../SF_Agentforce/INDEX.md) · [Custom Agent Actions](../../SF_Agentforce/INDEX.md)
...
**Level:** Complex · **Probes:** [Custom Agent Actions](../../SF_Agentforce/INDEX.md) · [Flows as Agentforce actions](../../SF_core/04-flow-and-automation/23-flows-as-agentforce-actions.md) · [Custom Lightning types for agent output](../../SF_core/03-lwc-and-slds/19-custom-lightning-types-for-agent-output.md) · [Trust Layer](../../SF_Agentforce/INDEX.md)
