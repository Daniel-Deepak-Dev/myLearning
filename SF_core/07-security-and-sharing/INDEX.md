...
- **17–19** feed [06-integration · 15 OAuth](../06-integration-and-apis/15-oauth-flows-and-authorization.md) and [05-experience-cloud · 10 SSO](../05-experience-cloud-lwr/10-authentication-self-registration-and-sso.md).
- **06, 14, 15, 26** are the internal half of [05-experience-cloud · 11 Public site exposure audit](../05-experience-cloud-lwr/11-public-site-exposure-audit.md) — written in phase 18 after the **7 March 2026** advisory, and the place the guest-facing version of this area's controls is actually checked.
