...
- **Guest sharing rules are the only way a guest user sees a record**, are read-only by construction, and guests cannot own records at all. → [SF_Experience_Cloud · 07](../../SF_Experience_Cloud/07-guest-user-security-model.md)
