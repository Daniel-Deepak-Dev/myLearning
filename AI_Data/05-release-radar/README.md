...
- **When does the zip-slip fix reach an ordinary `sf` install?** As of 2026-08-02 02:55 UTC the `latest` dist-tag is **2.145.6**, which resolves SDR to the unpatched 12.37.2; the fix is only on `nightly` **2.147.3**, behind the Node 22 major. Two things to watch: whether `latest` crosses to 2.147.x, and whether a **12.x backport** ever appears for teams that cannot take Node 22. Check with `npm view @salesforce/cli dist-tags` and `npm view @salesforce/source-deploy-retrieve versions`. **No CVE or GitHub security advisory was published** — if one appears, the severity assessment is worth reading. _(Raised 2026-08-02.)_
- **SCUBA has no captured detail anywhere in this study base.** It is named consistently as part of Salesforce's agent-evaluation line beside CRMArena-Pro and GIFT-Eval, and that is all the radar knows. **Find the paper or repo and write it into [ai-research-and-benchmarks.md](ai-research-and-benchmarks.md).** _(Raised 2026-08-02.)_
...
## Coverage and staleness — 2026-08-02

| Topic file | Last touched *before* this run | Age | Touched this run |
|---|---|---|---|
| [agentforce-platform.md](agentforce-platform.md) | 2026-08-01 | 1d | ✅ Mobile SDK 262.1.2 / tag `18.26.8`; version table filled in with a correction |
| [data-360.md](data-360.md) | 2026-08-01 | 1d | ✅ reference-app rename (NextGenWealth → Agentic Advisor) |
| [developer-tooling-and-apis.md](developer-tooling-and-apis.md) | 2026-08-01 | 1d | ✅ SDR 13.0.1 zip-slip + the Node 22 CLI cut; heading order repaired |
| [trust-security-and-governance.md](trust-security-and-governance.md) | 2026-07-26 | **7d** | ✅ cross-link + the inbound-trust-boundary point — first update in 7 days |
| [pricing-and-certification.md](pricing-and-certification.md) | 2026-08-01 | 1d | ✅ heading order repaired (07-24 sat above three 07-26 entries) |
| [ai-research-and-benchmarks.md](ai-research-and-benchmarks.md) | — | **new** | ✅ **created this run** — seven scans of research findings relocated into contract shape |

**No topic file exceeded the 14-day gap-check threshold**, so no gap check was owed. `trust-security-and-governance.md` was the oldest at 7 days and has now been touched; it remains the file to watch, having once gone eight commits with zero updates. **The structural hole this table flagged for two runs is closed** — the research area now has a durable home, and its dated notes are back under the ≤25-line cap.

---

---

_Last updated: 2026-08-02 · Sources are linked inline in each topic file._
