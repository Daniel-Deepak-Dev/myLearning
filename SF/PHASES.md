...
- **16–17 before 18–19** — Experience Cloud deployment assumes 2GP and pipeline vocabulary. *(**Both have now run. Area 09 is complete at 25 topics**, so 18–19 are unblocked.)*
- **Movable:** the 08 Data block (14–15) had nothing downstream depending on it. *(Both ran here, out of numeric order with 16–19 still open — that was the point of calling the block movable. **Areas 08 and 09 are now complete**; the remaining work is 18–19, Experience Cloud.)*
