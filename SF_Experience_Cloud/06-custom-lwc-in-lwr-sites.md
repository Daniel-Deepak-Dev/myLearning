...
- [03-lwc · 18 Error handling & user feedback](../SF_core/03-lwc-and-slds/18-error-handling-and-user-feedback.md) — the toast portability rule in full
- [03-lwc · 21 Local dev & the Lightning dev server](../SF_core/03-lwc-and-slds/21-local-dev-and-lightning-dev-server.md) — `sf lightning dev site`
