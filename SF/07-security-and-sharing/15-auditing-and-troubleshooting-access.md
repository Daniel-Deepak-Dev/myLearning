...
- **Who Sees What Explorer lives in Security Center**, which is a **paid add-on** — check entitlement before designing a process around it. The product and posture story is [22](INDEX.md) *(phase 11)*.
