...
- **A data space is part of the trigger definition**, not an afterthought — the same DMO in two data spaces is two different trigger sources. → [SF_Data_360/03](../../SF_Data_360/INDEX.md)
...
- **Data actions cost Data Services Credits at volume.** A chatty trigger on a high-throughput DMO is a billing decision. → [GLOSSARY.md](../../GLOSSARY.md)
