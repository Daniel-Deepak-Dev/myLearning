...
> **Correction (2026-08-03):** this entry said **#184–#186** were open. **#184** (EXAONE-Forecast, LG AI Research) and **#186** (FastCastrage v5) **merged on 2026-08-03**; **#185** (EXAONE-Forecast-Agent) is still open; and a new **#187** was opened and **closed unmerged** as a duplicate of #186. The repository now shows **1 open / 149 closed** (checked **2026-08-03 02:41 UTC**). It also corrects the table below: **FastCastrage's `org` field was wrong on the public leaderboard** and was changed to **`sme`** — so the "TW3 Partners" attribution this radar recorded on 2026-08-01 is the value that was withdrawn.

**What changed.** Between **03:37 and 03:41 UTC on 2026-07-31**, five pull requests (**#179–#183**) merged into [`SalesforceAIResearch/gift-eval`](https://github.com/SalesforceAIResearch/gift-eval), taking the public leaderboard to **117 result sets**. Three more (**#184–#186**) were submitted the same day and were still **open** as of 2026-08-02 02:48 UTC.
...
- **"On the leaderboard" and "submitted to the leaderboard" are different states.** #184–#186 were open nine hours after the merge batch, and stayed open for **three days** — #184 and #186 merged 2026-08-03, **#185 is open still**.
...
**Status:** Community leaderboard submissions, **not Salesforce research output**. #179–#183 merged 2026-07-31; **#184 and #186 merged 2026-08-03, #185 open, #187 closed unmerged**. No paper, model or blog post accompanied any of them.
