...
- **Apex actions may break on upgrade to 67.0.** Custom Apex types used as invocable action inputs now need a **visible no-arg constructor** (public, or global for packaged classes). Detail in [custom agent actions](../05-custom-agent-actions/notes.md).
