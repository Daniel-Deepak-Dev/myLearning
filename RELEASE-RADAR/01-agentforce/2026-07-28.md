...
|---|---|---|
| **MuleSoft Agent Fabric** | **Zero mentions repo-wide** — this radar included — despite launching September 2025 | [02-salesforce-ai/11-agent-fabric-and-interop](../../SF_Agentforce/INDEX.md) · [developer-tooling-and-apis.md](../developer-tooling-and-apis.md) |
| **Agentforce Voice / Contact Center** | One passing bullet; "Contact Center" absent outside a field note, despite **GA since 2026-02-23** | [02-salesforce-ai/12-voice-and-contact-center](../../SF_Agentforce/INDEX.md) · [agentforce-platform.md](../agentforce-platform.md) |
| **ADLC + Agentforce DX** | Scattered passing references in three files; the first-party command sequence never captured | [02-salesforce-ai/13-adlc-and-agentforce-dx](../../SF_Agentforce/INDEX.md) · [developer-tooling-and-apis.md](../developer-tooling-and-apis.md) |
| **Prebuilt agents / buy vs build** | Commerce and Contact Center absent outside this radar; no decision framework anywhere | [02-salesforce-ai/14-prebuilt-agents-and-buy-vs-build](../../SF_Agentforce/INDEX.md) |
