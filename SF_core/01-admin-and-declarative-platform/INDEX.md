...
- [19 · Agentforce in Setup](19-agentforce-in-setup-and-ai-assisted-admin.md) is the seam into [SF_Agentforce/](../../SF_Agentforce/INDEX.md) — the admin surface here, the agent platform there.
...
- [12 · Approvals](12-approval-processes-and-approval-orchestration.md) pairs with [04-flow · 17 Approval Orchestration](../04-flow-and-automation/17-approval-orchestration.md), written in phase 09 — this note holds the choice and the admin surface, that one holds the Flow mechanics.
